...
## 🚀 Core Features
* **98.81% AI Detection Accuracy:** Leverages a pre-trained BigML model (`diano_model.json`) to distinguish between legitimate traffic and malicious threats.
...
2. `diano_model.json` - The trained machine learning model containing security heuristics.
